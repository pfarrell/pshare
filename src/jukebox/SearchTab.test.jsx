...
test('searches on submit and renders album and track results', async () => {
  apiService.search.mockResolvedValue({
    data: {
      results: [
        ...
        { type: 'artist', data: { id: 2, name: 'Not Shown Artist', image_path: 'n.jpg' } },
      ],
      tracks: [
  ...
  expect(screen.queryByText('Not Shown Artist')).not.toBeInTheDocument();
});
